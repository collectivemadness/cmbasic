		...
		<?php $counter = $counter + 1;?>
			...
			<?php if(5 == $counter) : { ?>
	            ...
	            <div class="uk-position-center">
	              <h3 class="uk-h4 uk-text-uppercase uk-text-bold uk-text-center uk-margin-remove">Advertising</h3>
	              <h4 class="uk-h5 uk-margin-remove uk-text-bold">(Every 6th post)</h4>
	            </div>
	        </div>
				</div>
			<?php } endif; ?>
